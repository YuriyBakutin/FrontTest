import { __extends, __assign, __spreadArrays } from '../../tslib/tslib.es6.js';
import { createElement, Fragment, createRef } from '../common/vdom.js';
import { getStickyHeaderDates, ViewRoot, SimpleScrollGrid, getStickyFooterScrollbar, createFormatter, buildNavLinkData, DayCellRoot, WeekNumberRoot, RenderHook, DayCellContent, buildSegTimeText, EventRoot, StandardEvent, isPropsEqual, getSegMeta, buildEventRangeKey, BgEvent, renderFill, PositionCache, mapHash, applyStyle, addDays, NowTimer, DayHeader, addWeeks, diffWeeks, DateProfileGenerator, createPlugin, renderScrollShim, DateComponent, setRef, BaseComponent, sortEventSegs, intersectRanges, RefMap, DelayedRunner, memoize, Slicer, DaySeriesModel, DayTableModel, identity, EventApi } from '../common/main.js';
